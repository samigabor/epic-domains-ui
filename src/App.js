...
const CONTRACT_ADDRESS = "0xeB364bE8928f6D46e9D5068CbC675e940426B05c";
...
const App = () => {
  ...
  const mintDomain = async () => {
    if (!domain) {
      alert("Domain name is mandatory!");
      return;
    }
    if (domain.length < 3) {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img
        src="https://media1.giphy.com/media/3oEduVObV0nnnTSDCg/200w.webp?cid=ecf05e472rc8x5rofbz73oeyn0auht57jc4xld4c85kllkaw&rid=200w.webp&ct=g"
        alt="Epic gif"
      />
      <button
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="whats ur epic power"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🐱 Epic Service</p>
